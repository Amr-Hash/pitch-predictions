...
Kickoffs sourced from the official CBS/FIFA Eastern Time schedule, converted to UTC
via America/New_York (EDT, UTC-4 in June). Egypt summer (EEST, UTC+3) is handled
automatically when displaying with Africa/Cairo.
...
WC2026_GROUP_MATCHES = [
    ...
    ("C", 2, "BRA", "HAI", "2026-06-20T01:00:00Z"),
    ("D", 2, "TUR", "PAR", "2026-06-20T04:00:00Z"),
